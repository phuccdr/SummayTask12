...
import com.eco.summaytask12.model.device.Device
import com.eco.summaytask12.repository.datastorage.MockDeviceData
import java.util.Locale

class DeviceRepository {
    private val mockDevices: MutableList<Device> = MockDeviceData.devices
