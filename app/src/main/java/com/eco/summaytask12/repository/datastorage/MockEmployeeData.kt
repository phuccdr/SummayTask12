...
object MockEmployeeData {
    val mockEmployees: MutableList<Employee> = mutableListOf(
        ...
        BackendDeveloper(
            ...
            cloudService = mutableListOf(
                "Google Cloud Platform", "MongoDB Atlas", "Redis Cloud",
                "Firebase", "Google App Engine", "BigQuery"
            )
        ),
        BackendDeveloper(
            name = "Nam Vu",
            ...
            cloudService = mutableListOf(
                "Microsoft Azure", "Azure SQL Database", "Azure Functions",
                "Azure DevOps", "Heroku", "DigitalOcean"
            )
        ),
