...
object MockEmployeeData {
    val mockEmployees: MutableList<Employee> = mutableListOf(
        ...
        // ========== INTERN ANDROID DEVELOPERS ==========
        InternAndroidDeveloper(
            name = "Linh Hoang",
            birthOfDate = "10/03/2003".stringToDate(),
            gender = Gender.FEMALE,
            address = "Thanh Xuan, Ha Noi",
            phone = "0924567890",
            email = "linh.hoang@ecomobile.com",
        ...
        InternAndroidDeveloper(
            name = "Dat Tran",
            birthOfDate = "22/08/2004".stringToDate(),
            gender = Gender.MALE,
            address = "Hai Ba Trung, Ha Noi",
            phone = "0935678901",
            email = "dat.tran@ecomobile.com",
        ...
        InternAndroidDeveloper(
            name = "My Nguyen",
            birthOfDate = "05/12/2003".stringToDate(),
            gender = Gender.FEMALE,
            address = "Dong Da, Ha Noi",
            phone = "0946789012",
            email = "my.nguyen@ecomobile.com",
        ...
        InternAndroidDeveloper(
            name = "Vinh Le",
            birthOfDate = "18/07/2004".stringToDate(),
            gender = Gender.MALE,
            address = "Cau Giay, Ha Noi",
            phone = "0957890123",
            email = "vinh.le@ecomobile.com",
    ...
    val mockInternDevelopers: List<InternAndroidDeveloper>
        get() = mockEmployees.filterIsInstance<InternAndroidDeveloper>()
